          ...
          <div className={`relative z-10 transition-all duration-1000 ${showContent ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            ...
            <div className={`space-y-4 max-w-2xl transition-all duration-1000 delay-2800 ${showContent ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              <p className="text-lg sm:text-xl md:text-2xl text-zinc-300 leading-relaxed">
                I build fullstack applications, and I care about owning them end-to-end. From planning how something ships, to making sure it's built the right way (clean architecture, proper testing, CI/CD, whatever the project actually needs).
              </p>

              <p className="text-base sm:text-lg text-zinc-400 leading-relaxed">
                I'm pretty great at debugging and root cause analysis. I'm especially good at taking control over someone else's code and figuring out how it actually works. </p>
