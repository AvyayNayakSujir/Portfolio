  ...
  return (
    <>
      <div className="relative z-10 flex min-h-screen items-center justify-center font-sans">
        ...
        <div
          className={`hidden md:flex fixed left-8 bottom-8 z-20 transition-all duration-1000 delay-700 ${showContent ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
        >
          <div className="flex flex-col gap-5 items-center">
            ...
            >
              <svg
                className="w-5 h-5 text-purple-500 group-hover:text-purple-400 transition-colors"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
        ...
        <main className="relative flex w-full max-w-4xl flex-col items-start justify-center px-6 py-20 sm:px-12 md:px-16">
          ...
          <div
            className={`relative z-10 transition-all duration-1000 ${showContent ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
          >
            ...
            {/* Description */}
            <div
              className={`space-y-4 max-w-2xl transition-all duration-1000 delay-2800 ${showContent ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
            >
              <p className="text-lg sm:text-xl md:text-2xl text-zinc-300 leading-relaxed">
                ...
                who’s passionate about engineering scalable systems and
                automating processes.
              </p>

              <p className="text-base sm:text-lg text-zinc-400 leading-relaxed">
                I enjoy the responsibility of owning the technical roadmap,
                ensuring that every piece of the architecture is stable,
              ...
              <div className="flex flex-row gap-4 pt-6">
                ...
                <a
                  href="https://drive.google.com/file/d/1va5rmITfoMNsk6fmuYNG-FZTy4KIdhPI/view?usp=sharing"
                  target="_blank"
                  rel="noopener noreferrer"
